...
export const getMyData= (payload) => async (dispatch) => {
  try {
...
module.exports = {
  MVCJsindexContent: indexContent,
  MVCJsmapPropsContent: mapPropsContent,
  MVCJspContent: pContent,
  MVCJslessContent: lessContent,
  MVCJsservicesContent: servicesContent,
  MVCJsmodelsContent: modelsContent
}
